...
OBJ = $(ROOTNAME)$(HW)$(FOPTION).o $(ROOTNAME)$(HW)$(FOPTION2).o
CSVOBJ =$(ROOTNAME)$(HW)$(FOPTION2).o CSVTest.o 
...
$(ROOTNAME)$(HW)$(FOPTION2): $(CSVOBJ)
	$(CC) -o $@ $^ $(CFLAGS)  $(LIBS)

test: $(ROOTNAME)$(HW)$(FOPTION2) $(CSVOBJ)
	./$(ROOTNAME)$(HW)$(FOPTION2) 
